...
--
-- Name: job_benchmarks; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.job_benchmarks (
    id bigint NOT NULL,
...
--
-- Name: job_benchmarks_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.job_benchmarks_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: job_benchmarks_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.job_benchmarks_id_seq OWNED BY public.job_benchmarks.id;
...
--
-- Name: job_benchmarks id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_benchmarks ALTER COLUMN id SET DEFAULT nextval('public.job_benchmarks_id_seq'::regclass);
...
--
-- Name: job_benchmarks job_benchmarks_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.job_benchmarks
    ADD CONSTRAINT job_benchmarks_pkey PRIMARY KEY (id);
